...
export default function GradientText({
  ...
  return (
    <motion.div
      className={`relative flex flex-row items-center justify-start font-medium overflow-hidden cursor-pointer ${showBorder ? 'py-1 px-2 rounded-[1.25rem] backdrop-blur' : ''} ${className}`}
